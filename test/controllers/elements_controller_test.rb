...
class ElementsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create element" do
    assert_difference('Element.count') do
      post elements_url, params: { element: { abbrev: @element.abbrev, description: @element.description, element_type_id: @element.element_type_id } }
    end
  ...
  test "should update element" do
    patch element_url(@element), params: { element: { abbrev: @element.abbrev, description: @element.description, element_type_id: @element.element_type_id } }
